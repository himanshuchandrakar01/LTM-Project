      ...
      <div class="container">
         ...
         <div class="row tw-mt-60">
            <div class="col-lg-4 col-md-12">
               <div class="tw-contact-box">
                  <div class="contact-heading">
                     <img src="assets/images/icon-image/office1.png" alt="" class="img-fluid">
                     <h3>United States</h3>
                  </div>
                  <!-- End Content Heading -->
                  <div class="contact-info-box-content">
                     ...
                     <p><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="5c313d35301c39243d312c3039723f3331">[email&#160;protected]</a></p>
                  </div>
            ...
            <div class="col-lg-4 col-md-12">
               <div class="tw-contact-box">
                  <div class="contact-heading">
                     <img src="assets/images/icon-image/office2.png" alt="" class="img-fluid">
                  ...
                  <div class="contact-info-box-content">
                     ...
                     <p>009-215-5596</p>
                     <i class="fa fa-envelope"></i>
                     <p><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="5b363a32371b3e233a362b373e75383436">[email&#160;protected]</a></p>
                  </div>
                  <!-- End content info box -->
               </div>
               <!-- End Contact Box -->
            ...
            <div class="col-lg-4 col-md-12">
               <div class="tw-contact-box">
                  <div class="contact-heading">
                     <img src="assets/images/icon-image/office3.png" alt="" class="img-fluid">
                     <h3>Great China</h3>
                  </div>
                  <!-- End Content Heading -->
                  <div class="contact-info-box-content">
                     ...
                     <p>009-215-5596</p>
                     <i class="fa fa-envelope"></i>
                     <p><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="1e737f77725e7b667f736e727b307d7173">[email&#160;protected]</a></p>
                  </div>
                  <!-- End content info box -->
               </div>
               <!-- End Contact Box -->
         ...
         <div class="contact-us-form">
            <form id="contact-form" class="contact-form" action="#" method="POST">
               ...
               <div class="text-center">
                  <button class="btn btn-primary tw-mt-40" type="submit">Contact US</button>
               </div>
            </form>
            <!-- Form end -->
         </div>
